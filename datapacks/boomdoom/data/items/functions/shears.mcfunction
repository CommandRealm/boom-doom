...
##execute as @a[scores={shearsdamage=1..},nbt={SelectedItem:{id:"minecraft:shears"}}] at @s run replaceitem entity @s weapon.mainhand air
##execute as @a[tag=playing,nbt={Inventory:[{id:"minecraft:shears"}]}] at @s unless entity @s[nbt={SelectedItem:{id:"minecraft:shears"}}] run scoreboard players reset @s shearsdamage
...
##execute as @a[scores={shearsdamage2=1..},nbt={SelectedItem:{id:"minecraft:shears"}}] at @s run replaceitem entity @s weapon.mainhand air
