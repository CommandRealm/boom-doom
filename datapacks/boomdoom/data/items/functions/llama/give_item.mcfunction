...
##execute positioned 0 58 0 run say @e[type=item,x=0,y=58,z=0,sort=nearest,limit=1]
...
execute unless data block 0 0 0 Items[{Slot:0b,id:"minecraft:stone"}] run loot give @p[nbt={RootVehicle:{Entity:{id:"minecraft:llama"}}},tag=playing,distance=..3] mine 0 0 0 stone{drop_contents:true}
