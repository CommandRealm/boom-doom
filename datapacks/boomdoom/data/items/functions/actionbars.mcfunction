...
execute as @a[nbt={SelectedItem:{id:"minecraft:snow_block"}},tag=playing] at @s run title @s actionbar {"text":"Drop to start an avalanche. A safepoint will be created where you used it.","color":"gray"}
