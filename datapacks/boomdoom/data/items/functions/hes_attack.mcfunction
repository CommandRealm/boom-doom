...
advancement grant @a[tag=playing,nbt={SelectedItem:{id:"minecraft:golden_shovel"}},scores={hesdamage=1..}] only advancements:custom/enhancement_scepter
scoreboard players reset @a[scores={hesdamage=1..}] hesdamage
item replace entity @s[nbt={SelectedItem:{id:"minecraft:golden_shovel",tag:{Damage:31}}},tag=playing] weapon.mainhand with air