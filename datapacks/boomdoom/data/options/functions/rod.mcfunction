...
execute if score toggle unlimitedrod matches 1 run setblock 11 67 24 oak_wall_sign[facing=west]{front_text:{messages:["{\"text\":\"Panic\",\"bold\":false,\"color\":\"light_purple\"}", "{\"text\":\"Mode\",\"color\":\"light_purple\",\"bold\":false}", "{\"text\":\"ON\",\"color\":\"green\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_rod"}}']}} replace
execute if score toggle unlimitedrod matches 2 run setblock 11 67 24 oak_wall_sign[facing=west]{front_text:{messages:["{\"text\":\"Panic\",\"bold\":false,\"color\":\"light_purple\"}", "{\"text\":\"Mode\",\"color\":\"light_purple\",\"bold\":false}", "{\"text\":\"OFF\",\"color\":\"red\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_rod"}}']}} replace
