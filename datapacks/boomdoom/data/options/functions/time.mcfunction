...
execute if score time time matches 1 run setblock 4 67 25 oak_wall_sign[facing=north]{front_text:{messages:["{\"text\":\"Time\",\"bold\":false,\"color\":\"blue\"}", "{\"text\":\"of Day:\",\"color\":\"blue\",\"bold\":false}", "{\"text\":\"Afternoon\",\"color\":\"#fff000\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_time"}}']}} replace
execute if score time time matches 2 run setblock 4 67 25 oak_wall_sign[facing=north]{front_text:{messages:["{\"text\":\"Time\",\"bold\":false,\"color\":\"blue\"}", "{\"text\":\"of Day:\",\"color\":\"blue\",\"bold\":false}", "{\"text\":\"Night\",\"color\":\"#fff000\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_time"}}']}} replace
execute if score time time matches 3 run setblock 4 67 25 oak_wall_sign[facing=north]{front_text:{messages:["{\"text\":\"Time\",\"bold\":false,\"color\":\"blue\"}", "{\"text\":\"of Day:\",\"color\":\"blue\",\"bold\":false}", "{\"text\":\"Dusk\",\"color\":\"#fff000\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_time"}}']}} replace
execute if score time time matches 4 run setblock 4 67 25 oak_wall_sign[facing=north]{front_text:{messages:["{\"text\":\"Time\",\"bold\":false,\"color\":\"blue\"}", "{\"text\":\"of Day:\",\"color\":\"blue\",\"bold\":false}", "{\"text\":\"Random\",\"color\":\"#fff000\",\"bold\":true,\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute if score game game matches 1.. run function options:error\"}}", '{"text":"<<<         >>>","color":"#3cff00","bold":true,"clickEvent":{"action":"run_command","value":"/execute as @s at @s anchored eyes if score game game matches 0 run function options:click_time"}}']}} replace
