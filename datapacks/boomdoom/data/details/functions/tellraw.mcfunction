...
tellraw @a[scores={showdetails=63,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"--------------------Goat--------------------","bold":true,"color":"gray"},{"text":"\nGoats jump before exploding.","color":"dark_gray","bold":false}]
tellraw @a[scores={showdetails=64,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"--------------------Bee--------------------","bold":true,"color":"yellow"},{"text":"\nBees leave a poison cloud after exploding.","color":"gold","bold":false}]
tellraw @a[scores={showdetails=65,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"------------------Avalanche------------------","bold":true,"color":"white"},{"text":"\nDrop to start an avalanche. A safepoint will be created where you used it. Players will take damage if the avalanche hits them.","color":"gray","bold":false}]
tellraw @a[scores={showdetails=66,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"------------------Jump Boots------------------","bold":true,"color":"green"},{"text":"\nBoots enchanted with Feather Falling X. Equip to receive jump boost for a short time. The boots will permanently stay equipped.","color":"dark_green","bold":false}]
tellraw @a[scores={showdetails=67,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"------------------Whirlpool------------------","bold":true,"color":"dark_aqua"},{"text":"\nDrop to throw a whirlpool. The whirlpool will move nearby mobs towards itself.","color":"blue","bold":false}]
tellraw @a[scores={showdetails=68,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"-----------------Swapper Beam-----------------","bold":true,"color":"gold"},{"text":"\nDrop to shoot a laser. If this laser hits a player you will swap positions.","color":"yellow","bold":false}]
tellraw @a[scores={showdetails=69,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"--------------------Wall--------------------","bold":true,"color":"gray"},{"text":"\nDrop to create a temporary wall in front of your face.","color":"dark_gray","bold":false}]
tellraw @a[scores={showdetails=70,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"-------------Llama of Abundance-------------","bold":true,"color":"yellow"},{"text":"\nRide to obtain items.","color":"gold","bold":false}]
tellraw @a[scores={showdetails=71,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"----------------Screaming Goat----------------","bold":true,"color":"gray"},{"text":"\nScreaming Goats are the enhanced version of goats. They launch players up with them as they jump.","color":"dark_gray","bold":false}]
tellraw @a[scores={showdetails=72,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"-----------------Bee Swarm-----------------","bold":true,"color":"yellow"},{"text":"\nThe Bee Swarm is the enhanced version of bees. Two additionals bees are summoned upon enhancement. Any bees a part of the swarm have a larger explosion radius.","color":"gold","bold":false}]
