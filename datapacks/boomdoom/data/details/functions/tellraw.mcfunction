...
tellraw @a[scores={showdetails=65,crouch=1},tag=lobby,x=0,y=66,z=0,distance=..200] [{"text":"------------------Crazy Egg------------------","bold":true,"color":"yellow"},{"text":"\nThrow to summon crazy chickens.","color":"gray","bold":false}]
