...
execute if score Red checkwin matches 0.. if score mode mode matches 2 run advancement grant @a[team=teamgame,tag=joinred] only advancements:custom/win_game_tier_2
