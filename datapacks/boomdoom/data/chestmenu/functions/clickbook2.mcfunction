...
tellraw @a[scores={clickbook2=1}] {"text":"The Testers were:","bold":true,"color":"dark_green","extra":[{"text":" \nWickershim, WilfrErick, Nxmes, RosaPoo, GeneralGuy64, CheeseUnused, ManIntoWolf, CornerHard, CheckMC, BlenderEnder, MrZmiley, Arrgs, Moesh, J70, ChipChase, Calverin, SirDavidLevity, Spy_Guy1, GlytchIsYes, PrimePenguins, IronIllusion, and BobaFate.","color":"green","bold":false}]}
