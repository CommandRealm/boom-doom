tag @a[scores={clickhatanvil=1}] add clearechest
function chestmenu:clearechest
scoreboard players set @a[scores={clickhatanvil=1}] menu 5
scoreboard players set @a[scores={clickhatanvil=1}] clicklhelmet3 1
execute as @a[scores={clickhatanvil=1}] at @s run scoreboard players set @s hat 2
