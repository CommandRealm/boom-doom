...
execute if score $second pregame matches ..0 run function pregame:countdown_second_over
...
##Countdown ending
execute if score $ready_players pregame matches ..0 run function pregame:countdown_end

execute if score $countdown pregame matches 0 run function pregame:countdown_hit_0
...
title @a[scores={ready=1},gamemode=adventure] subtitle [{"text":"till the game begins. ","color":"gray"},{"text":"(","color":"white","bold":true},{"score":{"objective":"pregame","name":"$ready_players"},"color":"green","bold":false},{"text":"/","color":"white","bold":false},{"score":{"objective":"pregame","name":"$players_on"},"color":"green","bold":false},{"text":")","color":"white","bold":true}]
