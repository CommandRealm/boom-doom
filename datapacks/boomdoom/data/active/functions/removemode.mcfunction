...
execute if score mode mode matches 1 run setblock -34 59 25 oak_wall_sign[facing=east]{front_text:{messages:["{\"text\":\" \"}", "{\"text\":\"Mode:\",\"bold\":true,\"color\":\"dark_purple\",\"extra\":[{\"text\":\"\",\"color\":\"dark_green\"}]}", "{\"text\":\"Standard\",\"color\":\"dark_green\",\"bold\":true}", "{\"text\":\" \"}"]}} replace
execute if score mode mode matches 2 run setblock -34 59 25 oak_wall_sign[facing=east]{front_text:{messages:["{\"text\":\" \"}", "{\"text\":\"Mode:\",\"bold\":true,\"color\":\"dark_purple\",\"extra\":[{\"text\":\"\",\"color\":\"dark_green\"}]}", "{\"text\":\"Teams\",\"color\":\"light_purple\",\"bold\":true}", "{\"text\":\" \"}"]}} replace
