...
advancement grant @a[x=-27,y=70,z=37,dx=1,dz=2,dy=1,tag=!playing] only minecraft:custom/sit_in_tractor
advancement grant @a[x=-30,y=76,z=103,distance=..10,tag=!playing] only minecraft:custom/visit_nether
advancement grant @a[x=16,y=75,z=-29,distance=..10,tag=!playing] only minecraft:custom/visit_snowman
advancement grant @a[x=49,y=84,z=5,distance=..10,tag=!playing] only minecraft:custom/visit_cr
advancement grant @a[x=8,y=83,z=41,distance=..1,tag=!playing] only minecraft:custom/secret_map
advancement grant @a[advancements={custom/check_out_socials=true,custom/complete_tutorial=true,custom/secret_map=true,custom/sit_in_tractor=true,custom/visit_cr=true,custom/visit_nether=true,custom/visit_snowman=true}] only minecraft:custom/unlock_prefix
